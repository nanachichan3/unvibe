        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
            <div style={{
              ...
              fontFamily: 'var(--font-outfit)', fontWeight: 800, fontSize: '18px', color: '#fff',
              flexShrink: 0,
            }}>U</div>
            <span style={{ fontFamily: 'var(--font-outfit)', fontSize: '18px', fontWeight: 700, letterSpacing: '-0.01em', color: 'var(--text-primary)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }} className="desktop-nav">
            ...
            <a href="#how" style={{ color: 'var(--text-secondary)', textDecoration: 'none', fontSize: '14px', fontWeight: 500, transition: 'color 0.2s' }}
              onMouseEnter={e => (e.currentTarget.style.color = 'var(--text-primary)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'var(--text-secondary)')}>
              How it Works
            </a>
            <a href="https://github.com/nanachichan3/unvibe" target="_blank" rel="noopener"
        ...
        >
          {[
            ...
            <a key={label} href={href} onClick={closeMenu}
              style={{ color: 'var(--text-primary)', textDecoration: 'none', fontSize: '24px', fontFamily: 'var(--font-outfit)', fontWeight: 600 }}>
              {label}
            </a>
          ))}
        </div>
